...
const AdresSlachtofferMap: React.FC = () => {
  ...
  return (
    <IonPage>
      <Header title="Locatie slachtoffer" ></Header>
      ...
      <LoadScript googleMapsApiKey="AIzaSyDVTSYWpPAl0ROU_KnqA7U8AfRuHDn_WcE">
        <GoogleMap mapContainerStyle={containerStyle} center={center} zoom={14} onLoad={CurrentPosition}>
          <Marker onLoad={onLoad} position={center} />
        </GoogleMap>
      </LoadScript>
      </IonContent>
      <IonFooter class="ion-text-center">
          <IonButton routerLink="/page/AdresSlachtoffer" expand="full">Terug</IonButton>
        </IonFooter>
    </IonPage>
  );
};

export default AdresSlachtofferMap;
